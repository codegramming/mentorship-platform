INSERT INTO users VALUES (1000, 'Tayfur Ünal', 'test@test.com', '$2a$10$F00U/hsXrqV/p/b1XDilDeGNhCAFbi6dXlMe503FGCjLuC0ttXMRW','LOCAL',NULL, 'user1');
INSERT INTO users VALUES (1001, 'Tayfur Ünal', 'admin@test.com', '$2a$10$F00U/hsXrqV/p/b1XDilDeGNhCAFbi6dXlMe503FGCjLuC0ttXMRW','LOCAL',NULL, 'admin');
INSERT INTO mentor VALUES (1000, 'Backend Development', 'IN_PROGRESS', '.Net Core, SQL', 'Merhaba, ben Tayfur Ünal. Sakarya Üniversitesi Bilgisayar Mühendisliği mezunuyum ve 10 senedir yazılım mühendisi olarak çalışıyorum. ASP.NET, Javascript ve .NET Core kullanarak geliştirme yapıyorum.', 1000);
